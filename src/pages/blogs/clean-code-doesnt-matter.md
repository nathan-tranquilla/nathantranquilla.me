...
I recently joined a company that insists that AI agents write the majority of code. In my personal projects, I no longer write code, but leave it to AI agents. These are signals that coding is no longer a human task, but the task of an AI. If it's no longer a human task, do the human-centric battles around code matter such as clean code patterns or dynamic vs static type systems? What is the role of the human as it relates to AI and coding? 
...
Coding is no longer for humans, but don't panic. Your knowledge as a software developer is still very valuable. It has always been the trajectory of the software developer's career to move further away from code and into more abstract concepts; AI has simply made this transition happen earlier in your career. The time we spent coding has now shifted to time spent planning, architecting, delivering, iterating, and collaborating. There is more space for us to hold the higher-level concepts of a project in our brains, while we push the cognitive load onto AI, for better or for worse. I think it's for the better. We'll see. 