...
Here is a scenario you might find yourself in. You're trying to write code in an unfamiliar
scenario, a new language or a new library that you don't yet understand. You know the outcome you
want but you're unfamiliar with the details of how to get there. You ask AI, broadly speaking, to
code towards the desired outcome. Suddenly your IDE has been completely taken over with so much
code, you don't understand what's been written, you can't follow along, and you know you're glossing
over details that might be important to understand. It seems close, but not quite there. You ask AI
to make changes, and spend the next hour in a loop that AI can't seem to resolve.
